...
from config import MenuConsts


def menu_theme():
    if MenuConsts.playingMenuMusic:
        pygame.mixer.music.load(r"data\sounds\menu-theme-sound.mp3")
        pygame.mixer.music.set_volume(MenuConsts.wM)
        pygame.mixer.music.play(-1)
        MenuConsts.playingMenuMusic = False
...
def typing_theme():
    ...
    pygame.mixer.music.set_volume(MenuConsts.wS)
    pygame.mixer.music.play(-1)
...
def boss_take_hit_sound():
    ...
    randomSound.set_volume(MenuConsts.volS)
    randomSound.play()
...
def star_sound():
    ...
    starSound.set_volume(MenuConsts.volS)
    starSound.play()
